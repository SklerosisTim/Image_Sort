...
input_bt = Button((10, 1000, 100, 35), '---', manager, 'Выбрать рабочую папку')
output_bt = Button((10, 1040, 100, 35), '---', manager, 'Выбрать папку сохранения')
stat_bt = Button((10, 10, 200, 45), 'Статистика', manager, 'Колесо мыши - прокрутка статистики')
