...
Aespa.group += [winter, giselle, karina, ningning]
all_girl_btn += [winter, giselle, karina, ningning]
...
Blackpink.group += [jennie, jisoo, lisa, rose]
all_girl_btn += [jennie, jisoo, lisa, rose]
...
Dreamcatcher.group += [gah, dami, jiu, sua, dongie, sieon, yooheon]
all_girl_btn += [gah, dami, jiu, sua, dongie, sieon, yooheon]
...
Everglow.group += [aisha, iron, mia, onda, siheon, eu]
all_girl_btn += [aisha, iron, mia, onda, siheon, eu]
...
Fromis_9.group += [guri, jiwon, jisun, jiheon, nageon, saerom, haeon]
all_girl_btn += [guri, jiwon, jisun, jiheon, nageon, saerom, haeon]
...
Gidle.group += [mieon, minni, soeon, sujin, shuhua, uqi]
all_girl_btn += [mieon, minni, soeon, sujin, shuhua, uqi]
...
ITZY.group += [eji, lia, rujin, chaeren, yuna]
all_girl_btn += [eji, lia, rujin, chaeren, yuna]
...
IVE.group += [woneon, yujin]
all_girl_btn += [woneon, yujin]
...
Kep1er.group += [dayeon, yenyn, xaotin, yujin_kp]
all_girl_btn += [dayeon, yenyn, xaotin, yujin_kp]
...
LeSserafim.group += [kazuha, sakura, chaewon, yunjin]
all_girl_btn += [kazuha, sakura, chaewon, yunjin]
...
LOONA.group += [vivi, gowon, jinsoul, yojin, ives, kimlip, olivia, hasyl, heonjin, heejin, choerry, chu]
all_girl_btn += [vivi, gowon, jinsoul, yojin, ives, kimlip, olivia, hasyl, heonjin, heejin, choerry, chu]
...
Mamamoo.group += [moon, solar, hwasa, wheen]
all_girl_btn += [moon, solar, hwasa, wheen]
...
Momoland.group += [ahin, jooe, nancy]
all_girl_btn += [ahin, jooe, nancy]
...
NMIXX.group += [bae, sollun, haewon]
all_girl_btn += [bae, sollun, haewon]
...
Oh_My_Girl.group += [arin, binnie, jiho, mimi, synghee, hyojeon, yua]
all_girl_btn += [arin, binnie, jiho, mimi, synghee, hyojeon, yua]
...
Red_Velvet.group += [irene, wendy, joy, seulgi]
all_girl_btn += [irene, wendy, joy, seulgi]
...
Rocket_Punch.group += [juri, yeonhee, suyun, yunkyon]
all_girl_btn += [juri, yeonhee, suyun, yunkyon]
...
TWICE.group += [dahyeon, jihyo, mina, momo, nayeon, sana, tzu]
all_girl_btn += [dahyeon, jihyo, mina, momo, nayeon, sana, tzu]
...
VIVIZ.group += [sinb, umji, eunha, sowon]
all_girl_btn += [sinb, umji, eunha, sowon]
...
WJSN.group += [bona, dayeon_wj, yeorym, seola, chenxao]
all_girl_btn += [bona, dayeon_wj, yeorym, seola, chenxao]
...
Solo.group += [eyn, yena, chaeyon, nayn, somi, sunmi, sohee, eunbi, choa, chungha, tsuki, yuri]
all_girl_btn += [eyn, yena, chaeyon, nayn, somi, sunmi, sohee, eunbi, choa, chungha, tsuki, yuri]
